...
function test53(case,slvr,cycleDetection)
   ...
   #  timenmliqss=@belapsed QSS_Solve($odeprob,nmliqss1(),dQmin=$absTol,saveat=0.01,dQrel=$relTol,finalTime=100.0,maxErr=10*$relTol)
     resmliqss1= ("$(sol.algName)",(er1+er2)/2,sol.totalSteps,sol.simulStepCount,timenmliqss)
     @show resmliqss1
...
note="iters_abs-5"
resmliqss10=test53(note,mliqss1_SimulIter(),0)
resmliqss11=test53(note,mliqss1_SimulIter(),1)
resmliqss12=test53(note,mliqss1_SimulIter(),2)
resmliqss13=test53(note,mliqss1_SimulIter(),3)
resmliqss14=test53(note,mliqss1_SimulIter(),4)

resmliqss20=test53(note,mliqss2_SimulIter(),0)
resmliqss21=test53(note,mliqss2_SimulIter(),1)
resmliqss22=test53(note,mliqss2_SimulIter(),2)
resmliqss23=test53(note,mliqss2_SimulIter(),3)
resmliqss24=test53(note,mliqss2_SimulIter(),4)

resmliqss30=test53(note,mliqss3_SimulIter(),0)
resmliqss31=test53(note,mliqss3_SimulIter(),1)
resmliqss32=test53(note,mliqss3_SimulIter(),2)
resmliqss33=test53(note,mliqss3_SimulIter(),3)
resmliqss34=test53(note,mliqss3_SimulIter(),4)
