...
function test(case)
    ...
    timenmliqss=@belapsed QSS_Solve($odeprob,nmliqss1(),dQmin=$absTol,saveat=0.01,dQrel=$relTol,finalTime=100.0#= ,maxErr=1000*$relTol =#)
...
#reset_timer!()
 ...
 #=     XLSX.openxlsx("3sys _$case.xlsx", mode="w") do xf
        sheet = xf[1]
...
case="order1_exacteA_analyticboth_noallocImplemnt_only1Delta_qx_Inf_@belapsed"
test(case)