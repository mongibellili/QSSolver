function computeDerivative(states ::Int,index ::Int,order::Int,qssmodel :: QSSmodel,x :: Vector{Array{Float64}} ,q::Vector{Array{Float64}} ,tx::Vector{Array{Float64}} ,tq::Vector{Array{Float64}} )
