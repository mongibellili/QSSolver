...
@inline function integrateState(::Val{2}, x::Taylor1{Float64},cacheT::Taylor1{Float64},elapsed::Float64)
...
function integrate!(p::Taylor1{T}, a::Taylor1{T}, x::T) where {T<:Number}
  #p.coeffs[1]=x
  p[0]=x
...
function computeDerivative1( ::Val{2} ,j::Int,tq::MVector{T,Float64} ,x::Vector{Taylor1{Float64}},q::Vector{Taylor1{Float64}},d::Vector{Float64}, t::Taylor1{Float64},f::Function ,cacheT::Taylor1{Float64},simt::Float64 )where{T}
 #cacheT=f[j](q,d,t)
  cacheT=f(q,d,t)
...
function fbarier(x::Taylor1{Float64},cacheT::Taylor1{Float64})
